...
main() {
  ...
  local -a base_dirs=(
    ...
    "${AGENTIC_ROOT}/optional/openclaw/sandbox"
    ...
    "${AGENTIC_AGENT_WORKSPACES_ROOT}/claude"
    "${AGENTIC_AGENT_WORKSPACES_ROOT}/claude/workspaces"
    "${AGENTIC_AGENT_WORKSPACES_ROOT}/codex"
    "${AGENTIC_AGENT_WORKSPACES_ROOT}/codex/workspaces"
    "${AGENTIC_AGENT_WORKSPACES_ROOT}/opencode"
    "${AGENTIC_AGENT_WORKSPACES_ROOT}/opencode/workspaces"
    "${AGENTIC_AGENT_WORKSPACES_ROOT}/vibestral"
