...
def main() -> int:
    ...
    if args.mode == "openclaw":
        ...
        cfg = {
            ...
            "audit_log": audit_log,
            "default_model": os.environ.get("OPENCLAW_DEFAULT_MODEL", os.environ.get("AGENTIC_DEFAULT_MODEL", "qwen3.8:27b")),
        ...
        cfg = {
            ...
            "audit_log": audit_log,
            "default_model": os.environ.get("OPENCLAW_SANDBOX_DEFAULT_MODEL", os.environ.get("AGENTIC_DEFAULT_MODEL", "qwen3.8:27b")),
