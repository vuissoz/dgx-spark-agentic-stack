...
assert_mount_source "${hermes_cid}" "/state" "${agentic_root}/hermes/state"
assert_mount_source "${hermes_cid}" "/logs" "${agentic_root}/hermes/logs"
assert_mount_source "${hermes_cid}" "/workspace" "${hermes_workspaces_dir}"
