...
' || fail "agent-cli-base image is missing one of: codex claude opencode pi vibe openhands openclaw wrappers"
ok "agent-cli-base image exposes codex/claude/opencode/pi/vibe/openhands/openclaw commands"
