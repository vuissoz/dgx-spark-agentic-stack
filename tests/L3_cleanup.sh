...
mkdir -p "${AGENTIC_ROOT}/trtllm/models/trtllm-model" "${AGENTIC_ROOT}/comfyui/models/checkpoints"
printf 'keep-trt-model\n' > "${AGENTIC_ROOT}/trtllm/models/trtllm-model/model.bin"
...
[[ -f "${AGENTIC_ROOT}/trtllm/models/trtllm-model/model.bin" ]] || fail "cleanup must preserve TRT models by default"
