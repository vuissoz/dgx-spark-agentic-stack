...
assert doctor.get("attempt_totals") == {"requested": 50, "successes": 0, "failures": 50}
...
assert isinstance(doctor.get("artifact_checks"), list) and len(doctor["artifact_checks"]) == 10
