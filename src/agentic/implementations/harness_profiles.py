...
def get_all_profiles() -> dict[str, HarnessProfile]:
    ...
    return {
        "codex": HarnessProfile(
            ...
            upstream_version="v0.2.9",
            digest="sha256:placeholder-codex-digest",
            architecture="ARM64",
        ...
        "claude": HarnessProfile(
            ...
            digest="sha256:placeholder-claude-digest",
            architecture="ARM64",
        ...
        "opencode": HarnessProfile(
            ...
            upstream_version="v0.3.1",
            digest="sha256:placeholder-opencode-digest",
            architecture="ARM64",
        ...
        "kilocode": HarnessProfile(
            ...
            digest="sha256:placeholder-kilocode-digest",
            architecture="ARM64",
        ...
        "vibestral": HarnessProfile(
            ...
            upstream_version="v0.9.5",
            digest="sha256:placeholder-vibe-digest",
            architecture="ARM64",
        ...
        "hermes": HarnessProfile(
            ...
            digest="sha256:placeholder-hermes-digest",
            architecture="ARM64",
        ...
        "pi-mono": HarnessProfile(
            ...
            digest="sha256:placeholder-pi-digest",
            architecture="ARM64",
        ...
        "goose": HarnessProfile(
            ...
            digest="sha256:placeholder-goose-digest",
            architecture="ARM64",
        ...
        "openclaw": HarnessProfile(
            ...
            digest="sha256:placeholder-openclaw-digest",
            architecture="ARM64",
        ...
        "openhands": HarnessProfile(
            ...
            upstream_version="v0.9.4",
            digest="sha256:placeholder-openhands-digest",
            architecture="ARM64",
