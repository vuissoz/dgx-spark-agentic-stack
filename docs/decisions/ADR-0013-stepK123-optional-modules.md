...
- Keep `compose/compose.optional.yml` profile-driven with:
  ...
  - `optional-clawdbot` and `optional-mcp-catalog` (local minimal control-plane services),
