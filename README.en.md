...
For UIs such as OpenWebUI, the TRT catalog also exposes a readable alias `trtllm/nemotron-3-nano:30b`, while keeping the Hugging Face URL as the canonical identifier for direct calls and tests.
