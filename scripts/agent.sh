...
Usage:
  ...
  agent prereqs
  agent onboard [runtime flags...] [--compose-profiles ... --default-model ... --default-model-context-window ... --trtllm-models ... --openwebui-admin-email ... --openwebui-admin-password ... --grafana-admin-user ... --grafana-admin-password ... --openhands-llm-model ... --allowlist-domains ... --huggingface-token ... --optional-modules ... --output ... --non-interactive --require-complete]
