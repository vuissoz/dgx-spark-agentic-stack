...
Usage:
  ...
  agent prereqs
  agent onboard [runtime flags...] [--openwebui-admin-email ... --openwebui-admin-password ... --default-model ... --default-model-context-window ... --grafana-admin-user ... --grafana-admin-password ... --openhands-llm-model ... --allowlist-domains ... --huggingface-token ... --optional-modules ... --output ... --non-interactive --require-complete]
