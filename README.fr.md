...
Pour les UIs comme OpenWebUI, le catalogue TRT expose aussi un alias lisible `trtllm/nemotron-3-nano:30b`, tout en gardant l'URL Hugging Face comme identifiant canonique pour les appels directs et les tests.
...
Un seul modele TRT peut etre charge en memoire a la fois sur DGX Spark, mais plusieurs payloads locaux peuvent etre prepares et bascules a la demande.
